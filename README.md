...
3 рівень. Задача про шахового коня 
...
Результат: мінімальна необхідна кількість кроків – 6 (див рисунок, червоними хрестиками позначено Кінь може ходити у восьми можливих напрямках від даної клітини, як показано на наступному малюнку:
